\section{Extremely shallow buffer}\label{sec:background}
...
%which can be classified into following two categories:
%\begin{ecompact}
%\item \textbf{Private Pools:} dedicated buffers reserved to egress queues.
%\item \textbf{Shared Pools:} shared buffers that can be used once the destination queue's private pool has been used up.
%\end{ecompact}
